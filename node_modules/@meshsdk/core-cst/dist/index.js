...
var require_b4a = __commonJS({
  "../../node_modules/blake2b-wasm/node_modules/b4a/index.js"(exports, module) {
    "use strict";
...
import { blake2b as blake2b4, ready } from "@cardano-sdk/crypto";
...
var checkSignature = async (data, { key, signature }, address) => {
  ...
  if (address) {
    ...
    const credential = {
      hash: Hash28ByteBase162(coseSign1PublicKey.hash().hex()),
      type: 0
    };
  ...
  const hashedPayloadCompare = blake2b4.hash(hexData, 28) == builderPayload.toString("hex");
...
var deserializeScriptHash = (scriptHash) => ScriptHash(scriptHash);
...
var hashScriptData = (costModels, redemeers, datums) => {
  ...
  return Hash32ByteBase163.fromHexBlob(HexBlob7(hashHex));
};
  ...
  addSigningKeys = (txHex, signingKeys) => {
    ...
    for (let i = 0; i < signingKeys.length; i++) {
      ...
      if (keyHex) {
        ...
        const signature = cardanoSigner.sign(HexBlob8(cardanoTx.getId()));
        ...
        default: {
          cardanoOutput.setScriptRef(
            Script.newNativeScript(
              NativeScript.fromCbor(HexBlob8(output.referenceScript.code))
            )
          );
          break;
        }
      ...
      switch (script.scriptType) {
        case "Native": {
          nativeScriptArray.push(
            NativeScript.fromCbor(HexBlob8(script.scriptCbor))
          );
          break;
        }
        case "PlutusV1": {
          plutusV1ScriptArray.push(
            PlutusV1Script.fromCbor(HexBlob8(script.scriptCbor))
          );
          break;
        }
        case "PlutusV2": {
          plutusV2ScriptArray.push(
            PlutusV2Script.fromCbor(HexBlob8(script.scriptCbor))
          );
          break;
        }
        case "PlutusV3": {
          plutusV3ScriptArray.push(
            PlutusV3Script.fromCbor(HexBlob8(script.scriptCbor))
          );
          break;
        }
      }
