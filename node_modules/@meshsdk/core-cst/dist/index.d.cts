...
declare const TransactionId: (value: string) => any;
...
declare const ScriptHash: (value: string) => Crypto.Hash28ByteBase16;
...
declare const Ed25519PublicKeyHex: {
...
declare const Hash28ByteBase16: (value: string) => Crypto.Hash28ByteBase16;
type Hash28ByteBase16 = Crypto.Hash28ByteBase16;
declare const Hash32ByteBase16: (value: string) => any;
...
declare const DatumHash: (value: string) => any;
...
declare const blake2b: Crypto.Blake2b;
...
declare const deserializeScriptHash: (scriptHash: string) => ScriptHash;
...
declare const scriptHashToBech32: (scriptHash: string, stakeCredentialHash?: string, networkId?: number, isScriptStakeCredentialHash?: boolean) => any;
declare const v2ScriptToBech32: (scriptCbor: string, stakeCredential?: string, networkId?: number, isScriptStakeCredential?: boolean) => any;
declare const scriptHashToRewardAddress: (hash: string, networkId?: number) => any;
declare const keyHashToRewardAddress: (hash: string, networkId?: number) => any;
...
declare const toCardanoAnchor: (anchor: Anchor) => Cardano.Anchor;
declare const toCardanoGovernanceActionId: (govActionId?: GovernanceActionId) => Cardano.GovernanceActionId | null;
declare const toCardanoProposalProcedure: (governanceAction: GovernanceAction, anchor: Anchor, rewardAccount: string, deposit: bigint) => Serialization.ProposalProcedure;
