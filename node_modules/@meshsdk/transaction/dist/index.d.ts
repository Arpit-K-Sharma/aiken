...
declare type EstimateTxCosts = (selectionSkeleton: TransactionPrototype) => Promise<TransactionCost>;
declare type TokenBundleSizeExceedsLimit = (tokenBundle?: Asset[]) => boolean;
declare type ComputeMinimumCoinQuantity = (output: TxOutput) => bigint;
declare type MaxSizeExceed = (selectionSkeleton: TransactionPrototype) => Promise<boolean>;
...
interface IInputSelector {
    select: (preselectedUtoxs: TxIn[], outputs: Output[], implicitValue: ImplicitValue, utxos: UTxO[], changeAddress: string, constraints: BuilderCallbacks) => Promise<TransactionPrototype>;
}
 ...
 */
declare class LargestFirstInputSelector implements IInputSelector {
    private computeChangeOutputs;
    private expandUtxosUntilFeeCovered;
    select(preselectedUtxos: TxIn[], outputs: Output[], implicitValue: ImplicitValue, utxos: UTxO[], changeAddress: string, constraints: BuilderCallbacks): Promise<TransactionPrototype>;
}
...
declare class MeshTxBuilderCore {
     ...
     * @returns The MeshTxBuilder instance
     */
    proposal: (governanceAction: GovernanceAction, anchor: Anchor, rewardAccount: RewardAddress, deposit?: string) => this;
    /**
     ...
     */
    proposalScript: (scriptCbor: string, version: LanguageVersion) => this;
    /**
     ...
     * @param version The plutus version of the script
     */
    proposalTxInReference: (txHash: string, txIndex: number, scriptSize: string, scriptHash: string, version: LanguageVersion) => this;
    /**
     ...
     * @returns The MeshTxBuilder instance
     */
    proposalRedeemerValue: (redeemer: BuilderData["content"], type?: BuilderData["type"], exUnits?: {
        mem: number;
        steps: number;
    }) => this;
    /**
...
declare class Transaction {
    ...
    static attachMetadata(cborTx: string, cborTxMetadata: string): any;
    static deattachMetadata(cborTx: string): any;
    static maskMetadata(cborTx: string): any;
    static readMetadata(cborTx: string): any;
    static writeMetadata(cborTx: string, cborTxMetadata: string): any;
    /**
